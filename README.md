...
For any queires in a website, you would have copied the URL and the content to which you have query and put it into gemini for a summary or resolve your doubts, that monotonous copy pasting is removed by this chrome extension.


1. Clone the repo and upload the chrome_chatbot folder in the chrome extensions menu.
